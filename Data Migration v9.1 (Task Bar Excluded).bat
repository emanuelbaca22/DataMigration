...
echo   Favorites, Downloads, Pictures, Videos, Music, Google Bookmarks, Outlook Signatures, Quick Access and Mapped Network Drives
...
REM mkdir "%src%:\Users\%USERID%\OneDrive - Underwriters Laboratories\DataBackup\Quick Launch"
...
REM !
REM echo.
REM echo  Copying Pinned Applications...
REM robocopy "%src%:\Users\%USERID%\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch" "%src%:\Users\%USERID%\OneDrive - Underwriters Laboratories\DataBackup\Quick Launch" %roboOP% %backupLog%
...
REM echo.
REM echo  Exporting Task Bar Registry File...
REM reg export  "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\Taskband" "%src%:\Users\%USERID%\OneDrive - Underwriters Laboratories\DataBackup\Registry\Taskbar_BackUp.reg" /y
echo.
...
REM regedit /s "%src%:\Users\%USERID%\Temp_Reg\Taskbar_BackUp.reg"
echo.
...
echo.
REM echo  Restoring Pinned Applications...
REM Xcopy "%src%:\Users\%USERID%\Temp_Quick Launch" "%src%:\Users\%USERID%\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch" %xcopyOP%
REM echo.
...
REM mkdir "%newDST%:\DataBackup\%USERID%\Quick Launch"
...
REM echo.
REM echo  Copying Pinned Applications...
REM robocopy "%src%:\Users\%USERID%\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch" "%newDST%:\DataBackup\%USERID%\Quick Launch" %roboOP% %externalBackupLog%
REM echo.
REM Registry Importing
REM echo  Exporting Task Bar Registry File...
REM reg export  "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\Taskband" "%newDST%:\DataBackup\%USERID%\Registry\Taskbar_BackUp.reg" /y
echo.
echo  Exporting OneNote Registry File....
...
REM mkdir "%dst%:\DataBackup\%USERID%\Quick Launch"
...
REM echo.
REM echo  Copying Pinned Applications...
REM robocopy "%src%:\Users\%USERID%\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch" "%dst%:\DataBackup\%USERID%\Quick Launch" %roboOP% %externalBackupLog%
...
REM Registry Importing
REM echo   Exporting Task Bar Registry File...
REM reg export  "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\Taskband" "%dst%:\DataBackup\%USERID%\Registry\Taskbar_BackUp.reg" /y
echo.
echo   Exporting Mapped Network Drives File....
...
REM echo.
REM echo  Importing Task Bar Registry File...
REM regedit /s "%dst%:\DataBackup\%USERID%\Registry\Taskbar_BackUp.reg"
echo.
echo  Importing Mapped Network Drived File...
...
REM echo.
REM echo  Restoring Pinned Applications...
REM robocopy "%dst%:\DataBackup\%USERID%\Quick Launch" "%src%:\Users\%USERID%\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch" %roboOP% %externalRestoreLog%
...
REM mkdir "%spDST%:\DataBackup\%USERID%\Quick Launch"
...
REM echo.
REM echo  Copying Pinned Applications...
REM robocopy "%src%:\Users\%USERID%\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch" "%spDST%:\DataBackup\%USERID%\Quick Launch" %roboOP% %externalBackupLog%
REM echo.
REM Registry Importing
REM echo  Exporting Task Bar Registry File...
REM reg export  "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\Taskband" "%spDST%:\DataBackup\%USERID%\Registry\Taskbar_BackUp.reg" /y
echo.
echo  Exporting OneNote Registry File....
...
echo   Music, Google Bookmarks, Outlook Signatures, Quick Access, Mapped Network Drives, Microsoft AppData, 
echo   and Unique User Profile Folders
echo.
...
echo   Copying of the following Folders were complete: Desktop, Documents, Favorites, Downloads, Pictures, Videos, 
echo   Music, Google Bookmarks, Outlook Signatures, Quick Access, Mapped Network Drives, Microsoft AppData,
echo   Unique User Profile Folders and Unique Folders under C:\
echo.
echo   Please make sure to double check a couple of folders to make sure everything copied over
echo.  
